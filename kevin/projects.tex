...
\begin{cvprojects}
  ...
  % {\href{https://github.com/jzlotek/bc}{bc.dulcimer.live}}
  % {Nov. 2020 -- Dec. 2020}
  % {Vue, Go, Docker}
  % {
  %   \begin{cvitems}
  %     \item Developed a Vue Docker-containerized web app that simulates a proof-of-work blockchain simulator
  %     \item Created web UI to hit Go API endpoints and display block data
  %   \end{cvitems}
  % }
